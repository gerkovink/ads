...
|   April   | Start of project<br> Supervisors and Students fill in supervision documents<br> Students fill in Osiris Case     |
| $\star$ **30 June** | ADS student thesis conference$\star$ <br> Grading of presentations |
| 1 July | Thesis hand in |
| early July | Grading of theses by 1st and 2nd Supervisors <br> Entering the grades in Osiris |
| $\star$ September  |  Graduation ceremony $\star$ |

$\star$ Note that it is requested that you attend the graduation ceremony and the thesis presentation session of the supervised students. If no-one in the supervision team can attend the graduation ceremony it is much appreciated if you provide a written laudatio to the exam committee to be read in your name. 
...
Please check how many hours, if any, have been allocated to your name. It is not an issue to have students working on the same project with an individual twist. If you'd like to discuss this with me or if you'd like some advice, then I'd be more than happy to assist. 
